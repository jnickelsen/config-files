...
This function should only modify configuration layer settings."
  (setq-default
   ...
   ;; loaded using load/require/use-package in the user-config section below in ;; this file). If you need some configuration for these packages, then ;; consider creating a layer. You can also put the configuration in
...
;;(setq package-archives '(("melpa" . "http://melpa.milkbox.net/packages/") ;; this url is old and should be replaced by melpa.org/packages
...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  ...
  require 'jessfideloper-theme
  require 'palimpsest-mode
  require 'themes-megapack
  (add-to-list 'load-path "~/.emacs.d/private/themes/")
  (load-theme 'jessfideloper-theme t)
  ...
  (custom-set-variables
   ...
   '(package-selected-packages
     '(ace-jump-helm-line ace-link aggressive-indent all-the-icons auto-compile
                          auto-highlight-symbol catppuccin-theme
                          centered-cursor-mode clean-aindent-mode code-review
                          column-enforce-mode define-word devdocs diminish
                          ...
                          link-hint lorem-ipsum macrostep markdown-toc multi-line
                          nameless open-junk-file org-cliplink org-contrib
                          org-download org-mime org-pomodoro org-present
                          org-projectile org-rich-yank org-superstar orgit-forge
                          overseer palimpsest paradox password-generator pcre2el
                          popwin quickrun rainbow-delimiters request restart-emacs
