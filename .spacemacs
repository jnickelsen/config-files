  ...
  (custom-set-variables
   ...
   '(package-selected-packages
     '(a ace-jump-helm-line ace-link aggressive-indent alert all-the-icons
         auto-compile auto-highlight-symbol catppuccin-theme centered-cursor-mode
         clean-aindent-mode closql code-review column-enforce-mode dash-functional
         deferred define-word devdocs diminish dired-quick-sort disable-mouse
         doom-modeline doom-themes dotenv-mode drag-stuff dumb-jump edit-indirect
         ef-themes elisp-def elisp-demos elisp-slime-nav emacsql emojify emr
         ...
         indent-guide info+ inspector langtool link-hint llama log4e lorem-ipsum
         macrostep magit magit-section markdown-mode markdown-toc memoize
         multi-line nameless nerd-icons nyan-mode olivetti open-junk-file org
